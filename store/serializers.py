...
from store.models import ProductImage, Cart, CartItem, Customer, Order, OrderItem, Product, Collection, Review
...
class ProductImageSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        return ProductImage.objects.create(product_id=self.context['product_pk'], **validated_data)
